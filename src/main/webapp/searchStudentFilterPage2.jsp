...
<form method="post" action="filter"><!-- from action -->
      ...
      <h6> <label style="color:#2366a6;">* Mandatory</label> </h6>
         <input style ="display:none;" type="text" id="textbox" name="textbox" class="form-control form-control-lg" placeholder="text" required="required">
         <input style ="display:none;" type="number" id="numericvalue" name="numericvalue" class="form-control form-control-lg" placeholder="num" required="required">
		<select id="dynamicselect" name="dynamicselect" style="padding:10px; display:none;">
		</select>
		
		<input style ="display:none;" type="date" id="datevalue" name="datevalue" class="form-control form-control-lg" required="required">
		</div>

			<div class="col-md-2">
           		<input type="submit" value="Add Filter" class="btn btn-primary btn-lg px-5" onclick="Validate()">
           	</div>
