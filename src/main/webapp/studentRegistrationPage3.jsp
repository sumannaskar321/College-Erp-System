  ...
  <div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              <h2 class="mb-0"><b>Educational Details</b></h2>
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current">Educational Details</span>
      </div>
    </div>
...
<form method="post" action="studentRegistrationPage3"> <!-- form action -->
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <label for="class10Marks"><b>Class X Marks Percentage :</b></label>
                         <input type="number" id="class10Marks" name="class10Marks"  class="form-control form-control-lg" required>
                        ...
                        <div class="col-md-12 form-group">
                         <label for="furtherHigherStudies"><b>Highest Study Details :</b></label>
                       
                                            <div class="col-md-6">
                                            <div class="radio">
                                                <label><input type="radio" name="HighestQualification" value="class12Marks" >&nbsp;H.S Percentage</label>
                                              	<input style="display:none;" type="text" id="class12Marks" name="class12Marks" class="form-control form-control-lg">
                                              </div>
                                              <div class="radio">
                                                <label><input type="radio" name="HighestQualification" value="DiplomaMarks">&nbsp;Diploma Percentage</label>
                        ...
                        <label for="foreignLanguageDetails"><b>Foreign Language (put comma and add) :</b></label>
                         <input type="text" id="foreignLanguageDetails" name="foreignLanguageDetails"  class="form-control form-control-lg">
                        ...
                        <div class="col-md-12 form-group">
                        <label for="indiananguageDetails"><b>Indian Language (put comma and add) :</b></label>
                         <input type="text" id="indianLanguageDetails" name="indianLanguageDetails"  class="form-control form-control-lg" required>
