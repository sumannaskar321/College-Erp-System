...
%>
            ...
            <c:forEach var="user" items="${notices}"> 
                <tr>
                    <td><c:out value="${user.eventName}" /></td>	<!-- company_name -->
                    <td><c:out value="${user.eventDescription}" /></td>		<!-- job_desc -->
                    <td><c:out value="${user.eventPlace}" /></td> 	<!-- campus_selection -->
                    <td><c:out value="${user.organizeBy}" /></td>		<!-- date -->
                    <td><c:out value="${user.eventDate}" /></td>		<!-- start_time -->
                    <td><c:out value="${user.eventStartTime}" /></td>		<!-- end_time -->
                    <td><c:out value="${user.eventEndTime}" /></td>		<!-- venue -->
